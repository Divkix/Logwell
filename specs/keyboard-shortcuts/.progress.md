...
- [x] V4 Quality checkpoint - fc08158
- [x] 4.1 Full local CI verification - passed
- [x] 4.2 Create PR and verify CI pipeline - PR #10 created, CI passed (8edb902)
...
Task 4.3: Acceptance criteria checklist
...
- Enter key handler must only call preventDefault when a log is selected and modal is opened - otherwise it blocks buttons from working when focused (e.g., filter-toggle button).
